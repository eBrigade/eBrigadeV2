 ...
 *
 */
class EventTeamsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'team_chief_id' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'event_id' => 1,
            'team_chief_id' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
