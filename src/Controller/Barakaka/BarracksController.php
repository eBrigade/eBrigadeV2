<?php
namespace App\Controller\Barakaka;
...
class BarracksController extends AppController
{
    ...
    public function view($id = null)
    {
        $barrack = $this->Barracks->get($id, [
            'contain' => ['Cities', 'Users', 'Vehicles', 'Events', 'Materials', 'RescuePlans', 'BarracksMaterials']
        ]);
    ...
    public function add()
    {
        ...
        $this->set(compact('barrack', 'cities', 'users', 'vehicles'));
        $this->set('_serialize', ['barrack']);
    }
