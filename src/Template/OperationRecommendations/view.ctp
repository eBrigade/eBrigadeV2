<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Operation Recommendation'), ['action' => 'edit', $operationRecommendation->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Operation Recommendation'), ['action' => 'delete', $operationRecommendation->id], ['confirm' => __('Are you sure you want to delete # {0}?', $operationRecommendation->id)]) ?> </li>
...
<div class="operationRecommendations view large-9 medium-8 columns content">
    <h3><?= h($operationRecommendation->title) ?></h3>
    ...
    <div class="row">
        <h4><?= __('Title') ?></h4>
        <?= $this->Text->autoParagraph(h($operationRecommendation->title)); ?>
    </div>
    <div class="related">
        <h4><?= __('Related Operations') ?></h4>
        <?php if (!empty($operationRecommendation->operations)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($operationRecommendation->operations as $operations): ?>
            <tr>
