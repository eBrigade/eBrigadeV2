<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Operation Activity'), ['action' => 'edit', $operationActivity->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Operation Activity'), ['action' => 'delete', $operationActivity->id], ['confirm' => __('Are you sure you want to delete # {0}?', $operationActivity->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Operation Activities'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Operation Activity'), ['action' => 'add']) ?> </li>
        <li><?= $this->Html->link(__('List Operations'), ['controller' => 'Operations', 'action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Operation'), ['controller' => 'Operations', 'action' => 'add']) ?> </li>
    </ul>
</nav>
<div class="operationActivities view large-9 medium-8 columns content">
    <h3><?= h($operationActivity->title) ?></h3>
    ...
    <div class="row">
        <h4><?= __('Title') ?></h4>
        <?= $this->Text->autoParagraph(h($operationActivity->title)); ?>
    </div>
    <div class="related">
        <h4><?= __('Related Operations') ?></h4>
        <?php if (!empty($operationActivity->operations)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($operationActivity->operations as $operations): ?>
            <tr>
