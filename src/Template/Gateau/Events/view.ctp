...
<div class="events view col-lg-9 col-md-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            <th><?= __('City') ?></th>
            <td><?= $event->has('city') ? $this->Html->link($event->city->, ['controller' => 'Cities', 'action' => 'view', $event->city->]) : '' ?></td>
        </tr>
        <tr>
            <th><?= __('Title') ?></th>
            <td><?= h($event->title) ?></td>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= h($operations->caserne_id) ?></td>
                <td><?= h($operations->public_headcount) ?></td>
                <td><?= h($operations->operation_activity_id) ?></td>
                <td><?= h($operations->operation_environments) ?></td>
                <td><?= h($operations->operation_delays) ?></td>
                ...
                <td><?= h($operations->public_organization) ?></td>
                <td><?= h($operations->actors_headcount) ?></td>
                <td><?= h($operations->rescuers_total) ?></td>
                <td><?= h($operations->heacount_total) ?></td>
