<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Operation Delay'), ['action' => 'edit', $operationDelay->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Operation Delay'), ['action' => 'delete', $operationDelay->id], ['confirm' => __('Are you sure you want to delete # {0}?', $operationDelay->id)]) ?> </li>
...
<div class="operationDelays view large-9 medium-8 columns content">
    <h3><?= h($operationDelay->title) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($operationDelay->operations)): ?>
