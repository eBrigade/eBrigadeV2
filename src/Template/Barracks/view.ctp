...
<div class="row">
    <div class="col-md-5"> <!--colonne gauche-->
        ...
        <div class="panel panel-success">
            <div class="panel-heading">Matériels <?= $this->Html->badge(count($barrack->materials))  ?>
                <?= $this->Form->button(__(' <i class="glyphicon glyphicon-plus"></i>'),['id' => 'bt-del', 'class' => 'btn btn-success pull-right btn-add',]) ?>
                <?= $this->Form->button(__(' <i class="glyphicon glyphicon-arrow-down"></i>'),['id' => 'bt-join-mat', 'class' => 'btn btn-success pull-right btn-add',]) ?>
            </div>
            <div class="panel-body">
                ...
                echo "<tr id=".$matos->id."><td>".$matos->stock."</td><td>".$matos->material_type->name."</td><td><span class='glyphicon glyphicon-remove red pull-right hidecross' aria-hidden='true'></span></td></tr>";
                ?>
                    </tbody>
                </table>
            </div>
        ...
        <div class="panel panel-warning">
            <div class="panel-heading">Véhicules <?= $this->Html->badge(count($barrack->vehicles))  ?>
                <?= $this->Form->button(__(' <i class="glyphicon glyphicon-plus"></i>'),['id' => 'bt-vehi', 'class' => 'btn btn-warning pull-right btn-add',]) ?>
                <?= $this->Form->button(__(' <i class="glyphicon glyphicon-arrow-down"></i>'),['id' => 'bt-join-vehi', 'class' => 'btn btn-warning pull-right btn-add',]) ?>
            </div>
            <div class="panel-body">
    ...
    <div class="col-md-7"> <!--colonne droite-->
        <div class="panel panel-info">
            <div class="panel-heading">Personnels <?= $this->Html->badge(count($barrack->users))  ?>
                <?= $this->Form->button(__(' <i class="glyphicon glyphicon-plus"></i>'),['id' => 'bt-user', 'class' => 'btn btn-info pull-right btn-add',]) ?>
                <?= $this->Form->button(__(' <i class="glyphicon glyphicon-arrow-down"></i>'),['id' => 'bt-join-user', 'class' => 'btn btn-info pull-right btn-add',]) ?>
            </div>
            <div class="panel-body">
