...
--
-- Host: localhost
-- Generation Time: Sep 06, 2016 at 08:51 AM
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  `horaires` varchar(400) DEFAULT NULL,
...
INSERT INTO `events` (`id`, `city_id`, `bill_id`, `title`, `address`, `latitude`, `longitude`, `created`, `modified`, `is_closed`, `closed`, `price`, `canceled`, `canceled_detail`, `is_active`, `instructions`, `details`, `barrack_id`, `event_start_date`, `event_end_date`, `horaires`, `public`) VALUES
(1, 7, NULL, 'evenement numéro 1', '26 rue charles de gaules', NULL, NULL, '2016-09-05', '2016-09-05', 0, NULL, 122, 0, '', 0, NULL, 'blablabla   test details', NULL, '2016-09-10', '2016-09-13', '', 0),
(2, 8, NULL, 'evenement numero 2', '44 hadrange', NULL, NULL, '2016-09-05', '2016-09-05', 0, NULL, 333, 0, '', 0, NULL, 'test colonne details', NULL, '2016-09-14', '2016-09-14', '', 0),
(3, 12, NULL, 'evenement numero 3', '2 rue de bellefontaine', NULL, NULL, '2016-09-05', '2016-09-05', 0, NULL, 333, 0, '', 0, NULL, 'test colonne details', NULL, '2016-09-11', '2016-09-11', '', 0);
...
(16, 3, 4, 'Bienvenue sur votre messagerie privé', '<b><span style="color:rgb(0,0,255);">Blablabla :)</span></b>', '2016-09-05 14:46:37', 0, '');
...
--
-- Table structure for table `rescue_plans`
--
...
CREATE TABLE IF NOT EXISTS `rescue_plans` (
  ...
  `rescue_plan_activity_id` int(11) NOT NULL DEFAULT '0',
  `rescue_plan_environment_id` int(11) NOT NULL DEFAULT '0',
  `rescue_plan_delay_id` int(11) NOT NULL DEFAULT '0',
  `public_ris` float NOT NULL DEFAULT '0',
  `rescue_plan_type_id` int(11) NOT NULL DEFAULT '0',
  `rescue_plan_recommendation_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `rescue_plan_activities`
--

CREATE TABLE IF NOT EXISTS `rescue_plan_activities` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `rescue_plan_activities`
--

INSERT INTO `rescue_plan_activities` (`id`, `coefficient`, `title`) VALUES
...
--
-- Table structure for table `rescue_plan_delays`
--

CREATE TABLE IF NOT EXISTS `rescue_plan_delays` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `rescue_plan_delays`
--

INSERT INTO `rescue_plan_delays` (`id`, `coefficient`, `title`) VALUES
(1, 0.25, '< 10 min'),
...
--
-- Table structure for table `rescue_plan_environments`
--

CREATE TABLE IF NOT EXISTS `rescue_plan_environments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `coefficient` decimal(30,2) DEFAULT NULL,
  `title` longtext,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `rescue_plan_environments`
--

INSERT INTO `rescue_plan_environments` (`id`, `coefficient`, `title`) VALUES
...
--
-- Table structure for table `rescue_plan_recommendations`
--

CREATE TABLE IF NOT EXISTS `rescue_plan_recommendations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `rescue_plan_recommendations`
--

INSERT INTO `rescue_plan_recommendations` (`id`, `coefficient`, `title`) VALUES
...
--
-- Table structure for table `rescue_plan_types`
--

CREATE TABLE IF NOT EXISTS `rescue_plan_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(250) DEFAULT NULL,
...
--
-- Dumping data for table `rescue_plan_types`
--

INSERT INTO `rescue_plan_types` (`id`, `title`, `min`, `max`) VALUES
...
(1, 'ASSU', 'Ambulance de secours et de soins d''urgence', 'SECOURS', 'images/vehicules/VSAV.png'),
(2, 'CCFL', 'Camion citerne Forêt léger', 'FEU', 'images/vehicules/CCF.png'),
(3, 'CCFM', 'Camion citerne Forêt moyen', 'FEU', 'images/vehicules/CCF.png'),
(4, 'CCFS', 'Camion citerne Forêt super', 'FEU', 'images/vehicules/CCGC.png'),
(5, 'CCGC', 'Camion citerne grande capacité', 'FEU', 'images/vehicules/CCGC.png'),
(6, 'CTU', 'Camionnette tous usages', 'DIVERS', 'images/vehicules/VTU.png'),
(7, 'EPA', 'Echelle pivotante automatique', 'FEU', 'images/vehicules/EPA.png'),
(8, 'ERS', 'Embarcation de Reconnaissance et de Sauvetage', 'SECOURS', 'images/vehicules/BOAT1.png'),
(9, 'FPT', 'Fourgon pompe tonne', 'FEU', 'images/vehicules/FPT.png'),
(10, 'FPTL', 'Fourgon pompe tonne léger', 'FEU', 'images/vehicules/FPT.png'),
(11, 'FPTLHR', 'Fourgon pompe tonne léger hors route', 'FEU', 'images/vehicules/FMOGP.png'),
(12, 'GER', 'Groupe Electrogène Remorquable', 'DIVERS', NULL),
(13, 'MOTO', 'Motocyclette', 'DIVERS', 'images/vehicules/MOTO.png'),
(14, 'MPS', 'Moto de premiers secours', 'SECOURS', 'images/vehicules/MOTO.png'),
(15, 'PCM', 'Poste de Commandement Mobile', 'DIVERS', 'images/vehicules/PC.png'),
(16, 'QUAD', 'Véhicule quad', 'DIVERS', 'images/vehicules/QUAD.png'),
(17, 'REM', 'Remorque', 'DIVERS', NULL),
(18, 'VCYN', 'Véhicule Cynotechnique', 'DIVERS', 'images/vehicules/CYNO.png'),
(19, 'VELO', 'Vélo tout terrain', 'DIVERS', 'images/vehicules/VELO.png'),
(20, 'VL', 'Véhicule léger', 'DIVERS', 'images/vehicules/VL.png'),
(21, 'VLC', 'Véhicule Léger de Commandement', 'DIVERS', 'images/vehicules/VLCG.png'),
(22, 'VLHR', 'Véhicule léger hors route', 'DIVERS', 'images/vehicules/VLHR.png'),
(23, 'VPI', 'Véhicule polyvalent d''intervention', 'DIVERS', 'images/vehicules/VPI.png'),
(24, 'VPS', 'Véhicule de premier secours', 'SECOURS', 'images/vehicules/AMBULANCE1.png'),
(25, 'VSAV', 'Véhicule de secours aux blessés', 'SECOURS', 'images/vehicules/VSAV.png'),
(26, 'VSR', 'Véhicule de secours routier', 'SECOURS', 'images/vehicules/VSR.png'),
(27, 'VTD', 'Véhicule technique déblaiement', 'DIVERS', 'images/vehicules/VSD.png'),
(28, 'VTH', 'Véhicule technique hébergement', 'LOGISTIQUE', 'images/vehicules/CMIC.png'),
(29, 'VTI', 'Véhicule technique soutien intendance', 'LOGISTIQUE', 'images/vehicules/VIRT.png'),
(30, 'VTP', 'Véhicule de transport de personnel', 'DIVERS', 'images/vehicules/BUS.png'),
(31, 'VTU', 'Véhicule tous usages', 'DIVERS', 'images/vehicules/VTU.png');
...
ALTER TABLE `user_materials`
  ADD CONSTRAINT `user_materials_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `user_materials_ibfk_2` FOREIGN KEY (`material_id`) REFERENCES `materials` (`id`);
